namespace DNNGamification
{
    ...
    /// Module view control.
    /// </summary>
    public partial class Leaderboard : ModuleBase
    {
        #region Defines
        ...
        /// Template evaluator.
        /// </summary>
        private LeaderboardEvaluator _razor = null;
        ...
        private void BindLeaderboard()
        {
            try // try to handle BindLeaderboard
            {
                ...
                {
                    if (Int32.TryParse(Request.QueryString["GroupId"], out parsedGroupId)) groupId = parsedGroupId;
                }

                if (_settings.LeaderboardMode == LeaderboardMode.UserProfile)
                {
                    if (Int32.TryParse(Request.QueryString["UserId"], out parsedUserId)) userId = parsedUserId;
                }
                ...
                {
                    if (Int32.TryParse(Request.QueryString["UserId"], out parsedUserId)) friendsOfId = parsedUserId;
                }
        ...
        protected void rptPages_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            try // try to handle rptPages_ItemCommand
            {
                ...
                {
                    CurrentPage = Utils.ConvertTo<int>(e.CommandArgument.ToString()); BindLeaderboard();
                }
            }
            catch (Exception ex) // catch exceptions
            {
        ...
        protected void btnFirst_Click(object sender, EventArgs e)
        {
            ...
            {
                CurrentPage = 0; BindLeaderboard(); // bind leaderboard with data
            }
            catch (Exception ex) // catch exceptions
            {
                Exceptions.ProcessModuleLoadException(this, ex);
        ...
        protected void btnLast_Click(object sender, EventArgs e)
        {
            ...
            {
                CurrentPage = (Utils.ConvertTo<int>(ViewState["TotalPages"]) - 1); BindLeaderboard();
            }
            catch (Exception ex) // catch exceptions
            {
                Exceptions.ProcessModuleLoadException(this, ex);
        ...
        protected void btnPrevious_Click(object sender, EventArgs e)
        {
            ...
            {
                CurrentPage -= 1; BindLeaderboard(); // bind leaderboard with data
            }
            catch (Exception ex) // catch exceptions
            {
                Exceptions.ProcessModuleLoadException(this, ex);
        ...
        {
            int userId = UserInfo.UserID; var item = (data as ScoringLeaderboard);
            {
